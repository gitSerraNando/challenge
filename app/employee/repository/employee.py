...
class EmployeeService:
    ...
    def sales_per_employee(self, key_employee: str, start_date: date, end_date: date, current_user: User) -> List[EmployeeResponse]:
    ...
    def get_sales_summary(self, current_user: User, key_employee: str) -> List[SalesSummary]:
            if 'Admin' in current_user.user_type:
                query = """
                    SELECT KeyEmployee, SUM(Amount) as TotalSales, AVG(Amount) as AverageSales
                    FROM `mide-lo-que-importa-279017.celes.sales_view_by_employee`
                ...
                try:
                    ...
                    if result:
                        return SalesSummary(
                            ...
                            AverageSales=round(result.AverageSales, 2)
